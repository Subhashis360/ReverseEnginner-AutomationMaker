...
| 4b. Generate client | Build a runnable per-target API-automation script (ask language first) with dynamic device identifiers matching the app | `references/api-automation.md` |
